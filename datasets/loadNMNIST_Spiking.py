...
# def get_nmnist(data_path, network_config):
#     batch_size = network_config['batch_size']
#     train_set=NMNIST(data_path, train=True, use_frame=True, frames_num=network_config['n_steps'], split_by=split_by,
#                        normalization=normalization)
#
#     test_set=NMNIST(data_path, train=False, use_frame=True, frames_num=network_config['n_steps'], split_by=split_by,
#            normalization=normalization)
#
